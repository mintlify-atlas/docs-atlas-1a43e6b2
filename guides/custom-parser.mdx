---
title: "Add a custom lyrics format parser to AutoParser"
sidebarTitle: "Custom Parser"
description: "Implement ILyricsParser to add support for any custom lyrics format, then register it with AutoParser to enable automatic detection alongside built-in parsers."
---
...
The `ILyricsParser` interface has three methods, but you only need to implement two of them:
