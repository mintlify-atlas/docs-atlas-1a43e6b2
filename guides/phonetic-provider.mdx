...
description: "Implement PhoneticProvider to supply romanization or pronunciation annotations for lyrics. Configure TTMLParser and AutoParser to apply phonetics when TTML lacks them."
---
