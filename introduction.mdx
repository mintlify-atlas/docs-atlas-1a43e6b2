...
description: "Accompanist Lyrics Core parses LRC, Enhanced LRC, TTML, Lyricify Syllable, and Kugou KRC into a unified Kotlin data model with syllable-level timing."
---
