---
title: "Quickstart: Parse lyrics with Accompanist Lyrics Core"
sidebarTitle: "Quickstart"
description: "Parse your first lyrics file with Accompanist Lyrics Core using AutoParser, then access syllable timing, translations, and export to LRC."
---
