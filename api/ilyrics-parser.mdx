---
title: "ILyricsParser: implement a custom lyrics parser"
sidebarTitle: "ILyricsParser"
description: "ILyricsParser is the interface all lyrics parsers implement. Override canParse() and one parse() overload to add support for any custom or built-in lyrics format."
---
